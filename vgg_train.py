...
if __name__ == '__main__':
    ...
    parser.add_argument('-train_path', type=str, default='motion_data/train', help='train images dir')
    parser.add_argument('-test_path', type=str, default='motion_data/test', help='test images dir')
    ...
    train_loader = DataLoader(train_dataset, batch_size=opt.batch_size, num_workers=0, shuffle=True)  # Reference https://blog.csdn.net/zw__chen/article/details/82806900
    test_loader = DataLoader(test_dataset, batch_size=opt.batch_size, num_workers=0, shuffle=True)
